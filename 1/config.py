...
FEEDFORWARD_VISUAL_VX_SCALE = 1.0
...
FORMATION_FORWARD_OFFSET_CM =2.0
# 小角速度下不做 w×编队偏置的平移补偿，避免视觉/无线角速度抖动让
# 前后速度反复跳变；实际角速度命令仍按原始 w 下发。
RIGID_SLOT_W_COMP_DEADBAND_RAD_S = 0.25
